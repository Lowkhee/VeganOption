...
import squeek.veganoption.content.modules.Backpack;
...
import squeek.veganoption.integration.compat.Forestry;
...
public class BlockComposter extends Block implements IProbeInfoAccessor
{
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing side, float hitX, float hitY, float hitZ)
	{
		...
		if(IntegrationHandler.integratorExists(IntegratorBase.MODID_FORESTRY) && heldItemStack != null && heldItemStack.getItem().getClass() == Backpack.backpackAdvanced.getClass())
		{
				Forestry.getForestrySaplings(player, heldItemStack, GuiHelper.GuiIds.BACKPACK.ordinal());
		}
