...
public class BlockEnderRift extends BlockEndPortal implements IFluidFlowHandler
{
	...
	public void updateTick(World world, BlockPos pos, IBlockState state, Random random)
	{
		...
		if (random.nextFloat() < .50 && BlockHelper.isWater(world, aboveBlockPos))// % chance to create raw ender// && world.getBlockState(belowBlockPos).getBlock().isReplaceable(world, belowBlockPos))
		{
			BlockPos belowBlockPos = pos.down();
