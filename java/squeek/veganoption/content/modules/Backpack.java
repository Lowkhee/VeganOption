...
public class Backpack implements IContentModule
{
	...
	public void recipes()
	{
		...
		Minecraft.getMinecraft().getItemColors().registerItemColorHandler(ItemColorHandler.INSTANCE, backpackBasic); 
		Minecraft.getMinecraft().getItemColors().registerItemColorHandler(ItemColorHandler.INSTANCE, backpackAdvanced);
	}
