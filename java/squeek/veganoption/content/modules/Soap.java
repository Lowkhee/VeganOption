...
public class Soap implements IContentModule
{
	...
	public void recipes()
	{
		GameRegistry.addRecipe(new ShapelessOreRecipe(bucketLyeWater.copy(), 
													new ItemStack(Items.WATER_BUCKET), 
													ContentHelper.woodAshOreDict, 
													ContentHelper.woodAshOreDict, 
													ContentHelper.woodAshOreDict));
		...
		Modifiers.crafting.addInputsToRemoveForOutput(new ItemStack(soap), new ItemStack(Items.WATER_BUCKET));
		...
		//////////////////
		//GameRegistry.addRecipe(new ShapelessOreRecipe(lyeWater,
				//FluidRegistry.WATER.getBlock(), new InputItemStack(ContentHelper.woodAshOreDict, 3)));
	}
